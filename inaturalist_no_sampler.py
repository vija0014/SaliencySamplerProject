...
train_loader, test_loader = get_dataloaders(path,train_annotation,test_annotation,images,batch_size,224,sampling_test=224,decimate_factor=decimate_factor)


# Instantiate models
task_network = resnet.resnet101()
#saliency_network = saliency_network.saliency_network_resnet18()
model = task_network.cuda()
...
print('Test accuracy is ',1.0-(test_err/(i+1)))
